 ...
 * description :LAME interface class
 */
public class SimpleLame {
     ...
     *
     * @param buffer_l 左声道 PCM data .
     * @param buffer_r 右声道 PCM data .
     * @param samples  每个通道的采样数量 number of samples per channel.
     * @param mp3buf   result encoded MP3 stream. You must specified
     *                 "7200 + (1.25 * buffer_l.length)" length array.
     * @return mp3buf输出的字节数 ,可以是0
