...
public class LoggerUtils {
    ...
    private static final boolean LOGV  = IsDebug;
    private static final boolean LOGD  = IsDebug;
    private static final boolean LOGI  = IsDebug;
    private static final boolean LOGW  = IsDebug;
    private static final boolean LOGE  = IsDebug;
    ...
    public static void printCaller () {
        ...
        try {
            ...
            LoggerUtils.i(TAG, infoBuffer.toString());
        } catch (Exception e) {
