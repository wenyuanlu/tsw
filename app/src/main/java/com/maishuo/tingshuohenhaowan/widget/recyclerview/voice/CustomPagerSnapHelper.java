...
/**
 * description : 重写系统的PagerSnapHelpe
 */
public class CustomPagerSnapHelper extends SnapHelper {
    private static final int MAX_SCROLL_ON_FLING_DURATION = 800; // ms
    ...
    public int findTargetSnapPosition (RecyclerView.LayoutManager layoutManager, int velocityX, int velocityY) {
        //LogUtils.e("MyPagerSnapHelper返回的X=" + velocityX + "|Y=" + velocityY);
    ...
    protected LinearSmoothScroller createSnapScroller (RecyclerView.LayoutManager layoutManager) {
        ...
        return new LinearSmoothScroller(mRecyclerView.getContext()) {
            ...
            protected void onTargetFound (View targetView, RecyclerView.State state, Action action) {
                ...
                //LogUtils.e("createSnapScroller返回的X=" + dx + "|Y=" + dy);
