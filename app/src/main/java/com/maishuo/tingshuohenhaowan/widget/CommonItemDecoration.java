...
/**
 * Created by yun on 2018/3/9.
 * Description：RecyclerView的万能间距
 */
public class CommonItemDecoration extends RecyclerView.ItemDecoration {

    private final int horizontalSpace; // 整个RecyclerView与左右两侧的间距
    private final int verticalSpace; // 整个RecyclerView与上下的间距
    private final int leftMargin; // 每个item与左边的间距
    private final int topMargin; // 每个item与顶部的间距
    private final int rightMargin; // 每个item与右边的间距
    private final int bottomMargin; // 每个item与底部的间距
