...
public class PlayLoadingProgressbar extends View {
    ...
    public PlayLoadingProgressbar(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PlayLoadingProgressbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
