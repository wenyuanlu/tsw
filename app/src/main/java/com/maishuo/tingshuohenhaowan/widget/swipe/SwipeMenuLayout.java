package com.maishuo.tingshuohenhaowan.widget.swipe;
...
public class SwipeMenuLayout extends ViewGroup {
    ...
    protected void onMeasure (int widthMeasureSpec, int heightMeasureSpec) {
        //LogUtils.LOGD(TAG, "onMeasure() called with: " + "widthMeasureSpec = [" + widthMeasureSpec + "], heightMeasureSpec = [" + heightMeasureSpec + "]");
        ...
        //LogUtils.LOGD(TAG, "onMeasure() called with: " + "mRightMenuWidths = [" + mRightMenuWidths);
    ...
    protected void onLayout (boolean changed, int l, int t, int r, int b) {
        ...
        //LogUtils.LOGD(TAG, "onLayout() called with: " + "maxScrollGap = [" + maxScrollGap + "], l = [" + l + "], t = [" + t + "], r = [" + r + "], b = [" + b + "]");
    }
...
/*                    if (!mScroller.isFinished()) {
    ...
    public boolean onInterceptTouchEvent (MotionEvent ev) {
        //LogUtils.LOGD(TAG, "onInterceptTouchEvent() called with: ev = [" + ev + "]");
    ...
    public void smoothExpand () {
        //LogUtils.LOGD(TAG, "smoothExpand() called" + this);
    ...
    public void smoothClose () {
        //LogUtils.LOGD(TAG, "smoothClose() called" + this);
