...
public class PushHelper {
    ...
    public static void preInit (Context context,String channel) {
        ...
        String umAppkey = UMengPushEnum.APP_KEY.getKey();
        String umSecret = UMengPushEnum.MESSAGE_SECRET.getKey();

        //解决厂商通知点击时乱码等问题
        PushAgent.setup(context, umAppkey, umSecret);
    ...
    public static void init (final Context context, String channel) {
        ...
        UMConfigure.init(context, umAppkey, channel,
                UMConfigure.DEVICE_TYPE_PHONE, umSecret);

        //获取推送实例
        PushAgent pushAgent = PushAgent.getInstance(context);

        //TODO:需修改为您app/src/main/AndroidManifest.xml中package值
        pushAgent.setResourcePackageName("com.maishuo.tingshuohenhaowan");
    ...
    private static void pushSetting (Context context) {
        ...
        UmengMessageHandler msgHandler = new UmengMessageHandler() {
            ...
            public void dealWithNotificationMessage (Context context, UMessage msg) {
                ...
                Log.e(TAG, "notification receiver:" + msg.getRaw().toString());
            }
